...
def get_rooms_data():
    ...
    for room in rooms:
        print("Jatékosok száma a szobában:",4)
        if 4!= 0 :
...
#             active_DBGame = (
#                 db.query(DBGame)
#                 .filter(DBGame.game_id.in_(game_ids), DBGame.game_status == "run")
#                 .all()
#             )
...
#             db.commit()
#             print(
#                 f"Új játék létrehozva és hozzárendelve a szobához: {db_game.game_id} → {room_id}"
#             )
...
#                     player_sid = sockets.get(j.name)
#                     if player_sid:
#                         cards_in_hand = [str(k.name) for k in j.cards_in_hand]
#                         print("adatoooook" + str(player_data))
#                         print("starting_player" + str(active_name))
#                         print("cards_in_hand" + str(cards_in_hand))
#                         emit(
#                             "player_data",
#                             {
#                                 "name": j.name,
