...
from csotanypoker.client.constans import CARD_BACK
...
class NetworkManager:
    ...
    #             self.game_client.user.cards_in_hand.append(Animal[name])
    ...
    #                     self.game_client.user.cards_in_hand.append(Animal[k])
    ...
    #             print(
    #                 "Játékos:", player.name, "Kártyák a kezében:", player.cards_in_hand
    #             )
    #         self.game_client.passed = False
    ...
    #         self.game_client.game_state.question_card = CARD_BACK
    #         for player in self.game_client.game_state.players:
    ...
    #         self.game_client.game_state.question_card = Animal[data["card_type"]]
    #         self.game_client.selected_card = Animal[data["card_type"]]
