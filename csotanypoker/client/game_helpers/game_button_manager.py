import pygame
from csotanypoker.client.drawing_helpers.drawing_helpers import check_logout_button_interaction, check_rules_button_interaction, create_logout_button_rect, create_rules_button_rect
...
class GameButtonManager:
    ...
    def update_button_rects(self):
        self.screen.logout_button = create_logout_button_rect(
        ...
        self.screen.leave_button = pygame.Rect(
            self.screen.logout_button.x,
            self.screen.logout_button.y - 90,
            200, 75
        )
        self.screen.pass_button = pygame.Rect(
            self.screen.client.width // 2 - 50,
            self.screen.client.height // 2 + 130,
            100, 35
        )
    ...
    def update_button_states(self):
        ...
        if (hasattr(self.screen, "oke_button") 
        ...
        if (hasattr(self.screen, "pass_button") 
